...
const Hero = () => {
  return (
    <div className="text-white mx-auto overflow-y-scroll bg-cover bg-fixed bg-center bg-no-repeat shadow-lg bg-[url('https://www.eazywallz.com/cdn/shop/products/Blue-Sky-Clouds-Wallpaper-Mural_2a23bea6-7559-405b-92aa-d338d467d0da.jpg?v=1628807775')]">
