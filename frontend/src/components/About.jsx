    ...
    <div className="w-full py-16 px-4">
      <div className="mx-auto grid md:grid-cols-2">
        ...
        <div className="flex flex-col justify-center" >
          <p className=" uppercase font-bold"style={paragraphStyle}>In a rush?</p>
          <h1 className="md:text-4xl sm:text-3xl text-2xl fond-bold py-2" style={headingStyle}>
          ...
          <p style={paragraphStyle}>
            ...
            to share a scooter with another student running late to class, cutting costs in half.
          </p>
        </div>
      </div>
    </div>
