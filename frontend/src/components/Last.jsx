  ...
  return (
    <div className="w-full bg-[#8BB8E8] px-4 py-16 text-black">
      <div className="mx-auto grid md:grid-cols-2 gap-8">
        <img
          className="w-[500px] mx-auto my-4 rounded-3xl shadow-2xl"
          src={last}
          alt="last"
        ></img>
        <div className="flex flex-col justify-center">
          ...
          <p className="" style={paragraphStyle}>
            When a match is found, meet at your departure location when the time
            comes. Make sure you meet the person you matched with, and take the
            scooter ride to your destination.
          </p>
        </div>
      </div>
    </div>
