    ...
    <div class="lg:col-span-2 lg:col-start-1 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
      <div class="lg:pr-4">
        <div class="lg:max-w-lg">
          <h1 class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">A Faster Way To Get To Class</h1>
          <p class="mt-6 text-xl leading-8 text-gray-700">We wanted to create a more efficient way for students to go to classes everyday, since we realized that 
          many students are late to classes because they wake up too late.</p>
          <p class="font-bold mt-6 text-xl leading-8 text-black flex justify-center"> Anyways I hate CSS - Fuyi </p>
          <p class="font-bold text-xl text-black flex justify-center">I can't even fucking center this mf</p>
        </div>
      </div>
    </div>
              ...
              <div class="lg:pr-4">
                <div class="lg:max-w-lg">
                  <h1 class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
                    A Faster Way To Get To Class
                  </h1>
                  <p class="mt-6 text-xl leading-8 text-gray-700">
                    We wanted to create a more efficient way for students to go
                    to classes everyday, since we realized that many students
                    are late to classes because they wake up too late.
                  </p>
                  <p class="font-bold mt-6 text-xl leading-8 text-black flex justify-center">
                    {" "}
                    Anyways I hate CSS - Fuyi{" "}
                  </p>
                  <p class="font-bold text-xl text-black flex justify-center">
                    I can't even fucking center this mf
                  </p>
                </div>
              </div>
            </div>
...
>>>>>>> 60e4682118dc18f9206d25820ccbcfddbbf028ba
